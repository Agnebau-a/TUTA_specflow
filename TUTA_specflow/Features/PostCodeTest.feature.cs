...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("OX49 5NU", "200", "England", "464438", "395476", "E07000179", "nhs_ha", "South Central", null)]
        [NUnit.Framework.TestCaseAttribute("M32 0JG", "200", "England", "379988", "195677", "E08000009", "nhs_ha", "North West", null)]
        [NUnit.Framework.TestCaseAttribute("NE30 1DP", "200", "England", "435958", "568671", "E08000022", "nhs_ha", "North East", null)]
        [NUnit.Framework.TestCaseAttribute("OX49 5NU", "404", "", "", "", "", "", "", null)]
...
#line hidden
#line 13
 testRunner.And(string.Format("I should receive the status code of {0}", responseCode), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 14
 testRunner.And(string.Format("I validate country should have value {0}", country), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 15
 testRunner.And(string.Format("I validate coordinates should have {0} value and <nothings> value", eastings), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 16
